...
class FixtureInfoForm(forms.ModelForm):
    ...
    type=forms.ChoiceField(choices=FixtureInfoModel.fixture_type_list,label='Eşya Tipi',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}))
...
class RoomInfoForm(forms.ModelForm):
    ...
    people=forms.ChoiceField(choices=RoomInfoModel.room_people_list,label='Kişi Sayısı',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}))
    type=forms.ChoiceField(choices=RoomInfoModel.room_type_list,label='Oda Tipi',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}))
