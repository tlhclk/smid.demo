...
def add_fixture(request):
    if request.user.has_perm('stock_panel.add_fixtureinfomodel'):
        company_id=CompanyInfoModel.objects.get(pk=request.user.company_id_id)
...
def fixture_detail(request,fixture_no):
    if request.user.has_perm('stock_panel.add_fixtureinfomodel'):
        ...
        if fixture.company_id_id==CompanyInfoModel.objects.get(pk=request.user.company_id_id):
...
def delete_fixture(request,fixture_no):
    if request.user.has_perm('stock_panel.delete_fixtureinfomodel')  and FixtureInfoModel.objects.get(pk=fixture_no).company_id_id == CompanyInfoModel.objects.get(pk=request.user.company_id_id):
...
def room_detail(request,room_id):
    if request.user.has_perm('stock_panel.add_roominfomodel'):
        ...
        if room.company_id_id==CompanyInfoModel.objects.get(pk=request.user.company_id_id):
...
def delete_room(request,room_id):
    if request.user.has_perm('stock_panel.delete_roominfomodel') and RoomInfoModel.objects.get(pk=room_id).company_id_id == CompanyInfoModel.objects.get(pk=request.user.company_id_id):
