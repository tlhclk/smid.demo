    ...
    if request.user.has_perm('stock_panel.add_fixtureinfomodel'):
        ...
        if request.method=='POST':
            ...
            if formfixture.is_valid():
                ...
                fixture.save()
            return redirect('http://www.dormoni.com/stock_panel/fixture_table/')
...
def fixture_detail(request,fixture_no):
    if request.user.has_perm('stock_panel.view_fixtureinfomodel'):
        ...
        else: return redirect('http://www.dormoni.com/stock_panel/fixture_table/')
    else: return redirect('http://www.dormoni.com/user_panel/login/')
    ...
    if request.user.has_perm('stock_panel.add_roominfomodel'):
        ...
        if request.method=='POST':
            ...
            if formroom.is_valid():
                ...
                room.save()
            return redirect('http://www.dormoni.com/stock_panel/room_table/')
...
def room_detail(request,room_id):
    if request.user.has_perm('stock_panel.view_roominfomodel'):
        ...
        else: return redirect('http://www.dormoni.com/stock_panel/room_table/')
    else: return redirect('http://www.dormoni.com/user_panel/login/')
