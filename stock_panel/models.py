...
class RoomInfoModel(models.Model):
    ...
    room_no=models.CharField(max_length=4,primary_key=True,verbose_name='Room No: ')
...
class FixtureInfoModel(models.Model):
    ...
    room_no=models.ForeignKey(RoomInfoModel,unique=False,verbose_name='Room No: ',default='')
