...
urlpatterns = [
    ...
    url(r'^fixture_table/(?P<room_id>[0-9]+)$', views.table_fixture, name='Fixture Table'),
    ...
    url(r'^room/(?P<room_id>[0-9]+)$', views.room_detail, name='Room Details'),
    url(r'^room_table/$', views.table_room, name='room Table'),
    url(r'^room_edit/(?P<room_id>[0-9]+)$', views.edit_room, name='room Edit'),
    url(r'^room_delete/(?P<room_id>[0-9]+)$',views.delete_room,name='Room Delete'),
]