...
urlpatterns = [
    ...
    url(r'^asset/(?P<asset_id>[0-9]+)/', views.detail_asset, name='asset Details'),
    url(r'^asset_table/', views.table_asset, name='asset Table'),
    url(r'^asset_edit/(?P<asset_id>[0-9]+)', views.edit_asset, name='asset Edit'),
    url(r'^asset_delete/(?P<asset_id>[0-9]+)', views.delete_asset, name='asset Delete'),
