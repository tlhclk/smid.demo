...
class PersonAssetInfoModel(models.Model):
    ...
    asset_amount=models.CharField(max_length=10,verbose_name='Asset Amount: ',default='0')
    asset_debt=models.CharField(max_length=10,verbose_name='Asset Debt: ',default='10000')
    asset_desc=models.CharField(max_length=50,verbose_name='Asset Description: ',default='')
    asset_period=models.CharField(max_length=2,blank=True,default='10')
    asset_type=models.CharField(max_length=10,verbose_name='Asset Type',blank=True,choices=asset_type_list)
    # asset_one=models.CharField(max_length=5,default='0')
    # asset_two = models.CharField(max_length=5, default='0')
    # asset_three = models.CharField(max_length=5, default='0')
    # asset_four = models.CharField(max_length=5, default='0')
    # asset_five = models.CharField(max_length=5, default='0')
    # asset_six = models.CharField(max_length=5, default='0')
    # asset_seven = models.CharField(max_length=5, default='0')
    # asset_eight = models.CharField(max_length=5, default='0')
    # asset_nine = models.CharField(max_length=5, default='0')
    # asset_ten = models.CharField(max_length=5, default='0')
    # asset_eleven = models.CharField(max_length=5, default='0')
    # asset_twelve = models.CharField(max_length=5, default='0')
