...
class PersonalInfoForm(forms.ModelForm):
    ...
    city=forms.ChoiceField(choices=PROVINCE_CHOICES,label='İl',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}))
    ...
    blood_type=forms.ChoiceField(choices=PersonalInfoModel.blood_type_list,label='Emanet Türü',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}))
...
class PersonIDInfoForm(forms.ModelForm):
    def __init__(self, user, POST=None,*args, **kwargs):
        ...
        self.user=user
    nation=forms.ChoiceField(choices=PersonIDInfoModel.nation_list,label='Uyruğu',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}))
    idcard_type=forms.ChoiceField(choices=PersonIDInfoModel.idcard_type_list,label='Kimlik Türü',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}))
    gender=forms.ChoiceField(choices=PersonIDInfoModel.gender_list,label='Cinsiyeti',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}))
    medeni_hali=forms.ChoiceField(choices=PersonIDInfoModel.medeni_hal_list,label='Medeni Hali',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}))
    ...
    birth_place=forms.ChoiceField(choices=PROVINCE_CHOICES,label='Doğum Yeri',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}),required=False)
    register_vilage=forms.ChoiceField(choices=PROVINCE_CHOICES,label='Kayıtlı Olduğu İl',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}),required=False)
...
class StudentInfoForm(forms.ModelForm):
    ...
    type=forms.ChoiceField(choices=StudentInfoModel.student_type_list,label='Öğrenci Tipi',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}))
    school_name=forms.CharField(max_length=30,label='Okul Adı',required=False)
    education_year=forms.ChoiceField(choices=StudentInfoModel.year_list,label='Eğitim Yılı',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}))
    blood_type=forms.ChoiceField(choices=StudentInfoModel.blood_type_list,label='Kan Grubu',widget=forms.Select(attrs={"style":"height: 50px","class":"select2"}))
