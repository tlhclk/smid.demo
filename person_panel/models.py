...
class PersonIDInfoModel(models.Model):
    ...
    s_birthday = models.DateField(default='1990-12-31', verbose_name='Doğum Tarihi',max_length=10)
...
class PersonalInfoModel(models.Model):
    ...
    e_mail = models.EmailField(default='', verbose_name='Email Adresi',unique=True)
    personal_startday = models.DateField(default=get_date, verbose_name='İşe Başlangıç Tarihi',max_length=10)
    personal_endday = models.DateField(verbose_name='İşten Ayrılma Günü',default='',max_length=10,null=True,blank=True)
...
class StudentInfoModel(models.Model):
    ...
    e_mail = models.EmailField(default='',verbose_name='Email Adresi',unique=True)
    student_regday = models.DateField(default=get_date,verbose_name='Kayıt Tarihi',max_length=10)
